...
// **********************************************************************
// NB - event_id can be any event
// NB - poll_creator_user_id must have an account and must be invited to that event
//                           so can only be users 1 to 5
//                           and poll_creator_user_id must also have a matching record in event_invitee table for that event
//
